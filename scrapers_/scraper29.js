...
const scrapInfo = {
  store_url: `http://csdl.vietnamtourism.gov.vn/dest`,
  ajax_url: ``,
    ...
    const fetchData = () => {
      const doWork = async () => {
        ...
        let result = await page.evaluate(()=>{
          ...
          let items = document.querySelectorAll('.verticle-listing-caption');
          var data = [];
          items.forEach(item=>{
...
const processFetch = () => {
  fetchSource()
    .then((data) => {
      ...
      fs.writeFile('./results_/29.json', JSON.stringify(resData, null, 2), 'utf8', () => {
